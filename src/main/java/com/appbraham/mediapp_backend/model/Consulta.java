...
public class Consulta {
    ...
    //El valor de mappedBy, proviene del nombre de la variable "consulta" de la clase DetalleConsulta.
    //CascadeType.ALL, lo que le se inserta a consulta tambien se inserte en detalle_consulta, son objetos que depende uno del otro.
    //orphanRemoval = true, hace posible eliminar un item de la lista DetalleConsulta, ojo si es false remueve todo o nada.
